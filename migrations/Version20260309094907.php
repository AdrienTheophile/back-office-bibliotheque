 ...
 */
final class Version20260309094907 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE adherent (id_adh INT AUTO_INCREMENT NOT NULL, date_adhesion DATETIME NOT NULL, date_naiss DATE NOT NULL, adresse_postale VARCHAR(255) NOT NULL, num_tel VARCHAR(13) NOT NULL, photo VARCHAR(255) DEFAULT NULL, utilisateur_id INT NOT NULL, UNIQUE INDEX UNIQ_90D3F060FB88E14F (utilisateur_id), PRIMARY KEY (id_adh)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE emprunt (id_emp INT AUTO_INCREMENT NOT NULL, date_emprunt DATETIME NOT NULL, date_retour DATETIME NOT NULL, date_retour_reel DATETIME DEFAULT NULL, adherent_id INT NOT NULL, livre_id INT NOT NULL, INDEX IDX_364071D725F06C53 (adherent_id), INDEX IDX_364071D737D925CB (livre_id), PRIMARY KEY (id_emp)) DEFAULT CHARACTER SET utf8mb4');
