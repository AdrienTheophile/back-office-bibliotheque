 ...
 */
final class Version20260211160252 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE livre (id INT AUTO_INCREMENT NOT NULL, titre VARCHAR(255) NOT NULL, date_sortie DATETIME NOT NULL, langue VARCHAR(255) NOT NULL, photo_couverture VARCHAR(255) DEFAULT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE reservations (id INT AUTO_INCREMENT NOT NULL, date_resa DATETIME NOT NULL, adherent_id INT NOT NULL, livre_id INT NOT NULL, INDEX IDX_4DA23925F06C53 (adherent_id), UNIQUE INDEX UNIQ_4DA23937D925CB (livre_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
